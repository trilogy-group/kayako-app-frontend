...
Bugsnag.notifyReleaseStages = ["staging","production"];
  ...
  <body>
    ...
    <script src="{{ assets('frontend') }}__cp/assets/frontend-cp-ce3bbaefb8e7b2c8af8b2c7f168a125e.js" crossorigin="anonymous" ></script>
