...
Bugsnag.notifyReleaseStages = ["staging","production"];
  ...
  <body>
    ...
    <script src="{{ assets('frontend') }}__cp/assets/frontend-cp-ee62bba2214bc120ecbeab1fe7b0caa7.js" crossorigin="anonymous" ></script>
