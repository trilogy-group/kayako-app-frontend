...
Bugsnag.notifyReleaseStages = ["staging","production"];
  ...
  <body>
    ...
    <script src="{{ assets('frontend') }}__cp/assets/vendor-e0ba1964f9a38cde6a42a7c895f45e7b.js" crossorigin="anonymous" ></script>
    <script src="{{ assets('frontend') }}__cp/assets/frontend-cp-f20a7a30c8a7f03ab665a094e34c24a3.js" crossorigin="anonymous" ></script>
