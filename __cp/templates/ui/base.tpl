...
Bugsnag.notifyReleaseStages = ["staging","production"];
  ...
  <body>
    ...
    <script src="{{ assets('frontend') }}__cp/assets/frontend-cp-fee0dc79e376b7d762b9eead63907c4e.js" crossorigin="anonymous" ></script>
