...
Bugsnag.notifyReleaseStages = ["staging","production"];
  ...
  <body>
    ...
    <script src="{{ assets('frontend') }}__cp/assets/frontend-cp-b43569a4c35365823d4393f716dcd98a.js" crossorigin="anonymous" ></script>
