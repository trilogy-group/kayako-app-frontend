...
Bugsnag.notifyReleaseStages = ["staging","production"];
  ...
  <body>
    ...
    <script src="{{ assets('frontend') }}__cp/assets/frontend-cp-bef5e90e587d9b441b7a1a4942ba6b05.js" crossorigin="anonymous" ></script>
