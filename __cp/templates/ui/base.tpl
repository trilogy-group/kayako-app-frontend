...
Bugsnag.notifyReleaseStages = ["staging","production"];
  ...
  <body>
    ...
    <script src="{{ assets('frontend') }}__cp/assets/frontend-cp-96698f09099d00855bbca8a4da903167.js" crossorigin="anonymous" ></script>
