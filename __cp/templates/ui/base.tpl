...
Bugsnag.notifyReleaseStages = ["staging","production"];
  ...
  <body>
    ...
    <script src="{{ assets('frontend') }}__cp/assets/frontend-cp-ee754bad5d5af8f0b4f821dbbafa735a.js" crossorigin="anonymous" ></script>
