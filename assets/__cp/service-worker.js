function makeCaseUrl(t){return t.currentTarget.origin+"/agent/conversations/"+t.notification.data.id}function getActionsForNotification(t){return"case"===t.resource_type&&t.resource_id?[{action:"open-case",title:"Open conversation"}]:[]}self.addEventListener("notificationclick",function(t){if(""===t.action||"case"===t.notification.type){var i=makeCaseUrl(t)
