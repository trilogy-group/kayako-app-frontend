...
Bugsnag.notifyReleaseStages = ["staging","production"];
  ...
  <body>
    ...
    <script src="{{ assets('frontend') }}__cp/assets/frontend-cp-e3f12dd13fefffdcd2b033cb6d35832d.js" crossorigin="anonymous" ></script>
