...
Bugsnag.notifyReleaseStages = ["staging","production"];
  ...
  <body>
    ...
    <script src="{{ assets('frontend') }}__cp/assets/frontend-cp-5455a24c18d1c24d4ce6abb0dca193fc.js" crossorigin="anonymous" ></script>
