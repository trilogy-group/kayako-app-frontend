...
Bugsnag.notifyReleaseStages = ["staging","production"];
  ...
  <body>
    ...
    <script src="{{ assets('frontend') }}__cp/assets/frontend-cp-f2679f9f5f642d80eefceff662efc024.js" crossorigin="anonymous" ></script>
