...
Bugsnag.notifyReleaseStages = ["staging","production"];
  ...
  <body>
    ...
    <script src="{{ assets('frontend') }}__cp/assets/frontend-cp-35bfcfafe48310c8e593380a8586b5ab.js" crossorigin="anonymous" ></script>
