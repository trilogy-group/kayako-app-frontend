...
Bugsnag.notifyReleaseStages = ["staging","production"];
  ...
  <body>
    ...
    <script src="{{ assets('frontend') }}__cp/assets/frontend-cp-019a4d01a54ce73c7d099978bc9f4dff.js" crossorigin="anonymous" ></script>
