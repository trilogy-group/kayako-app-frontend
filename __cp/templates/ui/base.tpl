...
Bugsnag.notifyReleaseStages = ["staging","production"];
  ...
  <body>
    ...
    <script src="{{ assets('frontend') }}__cp/assets/frontend-cp-0f87e5da7e620ebd9690d6fc60be0a74.js" crossorigin="anonymous" ></script>
