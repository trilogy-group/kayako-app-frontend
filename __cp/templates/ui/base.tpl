...
Bugsnag.notifyReleaseStages = ["staging","production"];
    ...
    <link rel="stylesheet" href="{{ assets('frontend') }}__cp/assets/frontend-cp-665d99959e70da98e16a84a02b426e45.css" crossorigin="anonymous" integrity="sha256-/9HhGbSVkrnlfveD9jqSIwQvljo64rcX2UZM7mQKKPY= sha512-/BwR/pyuQKtEXRWwbGu8X+INA+S1uLlEdnxcqy7chQ/hkdKD6TEdBop9IrTBwxP8W2qjMSTKP8j2pDGWTbFIdg==" >
  ...
  <body>
    ...
    <script src="{{ assets('frontend') }}__cp/assets/vendor-5353ed57035a6d1f60a80b114dd91274.js" crossorigin="anonymous" integrity="sha256-l7Csy2mo+35VTmVnSH2F6OEZ1wyVyqWTADgQXdL4gHg= sha512-0OJopamI37RanJZkK/DEAfRSd39GmkVuCH25IDPAmqIJOvI3at30Qpl5uz54mt2f1vHb8V67NB1xj2ERNG3png==" ></script>
    <script src="{{ assets('frontend') }}__cp/assets/frontend-cp-fa2068b59d533fafd76f2656220d2c93.js" crossorigin="anonymous" integrity="sha256-vRr0Bur/4Kdc2WZRgbDGy3MalQqxXXOUWhcVCl48GTY= sha512-C85zJ9Jc3J0yBqaLprgYZSyGGoyzzuXXiGjrb+KLrSSifX+M+60Bc0f2BPYDPuTHhv1uPKTFHBmPeriHRCU5mg==" ></script>
