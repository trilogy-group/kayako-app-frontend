...
Bugsnag.notifyReleaseStages = ["staging","production"];
    ...
    <link rel="stylesheet" href="{{ assets('frontend') }}__cp/assets/vendor-39232d2e2f1ecca512ce479a7dfecb6d.css" crossorigin="anonymous" >
    <link rel="stylesheet" href="{{ assets('frontend') }}__cp/assets/frontend-cp-94c6532764be5f41f02f045d95c03a0b.css" crossorigin="anonymous" >
  ...
  <body>
    ...
    <script src="{{ assets('frontend') }}__cp/assets/intl/intl.complete-69f35eefb7f551e64be3e5792a221ae6.js" crossorigin="anonymous" ></script>

    <script src="{{ assets('frontend') }}__cp/assets/vendor-11c214fc36b80a8dd7aca4cd4ff09bd7.js" crossorigin="anonymous" ></script>
    <script src="{{ assets('frontend') }}__cp/assets/frontend-cp-731c48ab1dbc793eabbabceff453f6da.js" crossorigin="anonymous" ></script>
