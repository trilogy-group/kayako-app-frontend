...
Bugsnag.notifyReleaseStages = ["staging","production"];
  ...
  <body>
    ...
    <script src="{{ assets('frontend') }}__cp/assets/frontend-cp-cdb6fe848bb013cbc3d9c57aa55062fa.js" crossorigin="anonymous" ></script>
