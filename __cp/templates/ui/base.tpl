...
Bugsnag.notifyReleaseStages = ["staging","production"];
  ...
  <body>
    ...
    <script src="{{ assets('frontend') }}__cp/assets/frontend-cp-18ca68b205126408c70282b946a98e6a.js" crossorigin="anonymous" ></script>
