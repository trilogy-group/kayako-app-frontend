...
Bugsnag.notifyReleaseStages = ["staging","production"];
  ...
  <body>
    ...
    <script src="{{ assets('frontend') }}__cp/assets/frontend-cp-6e4089eafbd05c25bf8ab0cba8749088.js" crossorigin="anonymous" ></script>
