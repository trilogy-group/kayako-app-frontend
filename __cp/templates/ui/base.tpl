...
if (!('Intl' in window)) {
  ...
  document.body.appendChild(script);
    ...
    <script src="{{ assets('frontend') }}__cp/assets/frontend-cp-ad4a7531f77855fc34dd3bda32b41373.js" crossorigin="anonymous" defer integrity="sha256-F1zfL3l25AgqwQ2wZ7Yttxo1NbSFrYtokVnSCzN+bJ0= sha512-F8hMXseg1f1gy00FbNowkWJJMbYX0GZlUeDlY4VW3zSmE5fOSJQJBr/fnYq4qkbl4iACoVB9ROQMKou3C/BMPw==" ></script>
